...
@pytest.mark.parametrize(
    ...
    (
        ...
        "action_flow_usocket_latent_fm_sg_unite_arch_denoiser90m_sum14_cfg4_adamw_lr1e5_finalval1_s42",
...
def test_action_flow_denoiser90m_adamw_reuses_only_unite_architecture(monkeypatch):
    monkeypatch.setenv("PUSHSHAPES_DATA_ROOT", "/verified/cluster/datasets/Tsim_v2")
    cfg = _compose(
        "action_flow_usocket_latent_fm_sg_unite_arch_denoiser90m_sum14_cfg4_adamw_lr1e5_finalval1_s42"
    )
