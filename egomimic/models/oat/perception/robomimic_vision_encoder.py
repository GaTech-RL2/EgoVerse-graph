...
from egomimic.models.oat.common.pytorch_util import replace_submodules
from egomimic.models.oat.model.common.normalizer import LinearNormalizer, _normalize
from egomimic.models.oat.perception.base_obs_encoder import BaseObservationEncoder
from egomimic.models.oat.perception.crop_randomizer import CropRandomizer
        ...
        for port, value in obs_dict.items():
            if port in self.rgb_keys:
                ...
                if params is None:
                    nobs[port] = value
                    print(
                        f"no normalizer params for port {port}, skipping normalization."
                    )
                else:
