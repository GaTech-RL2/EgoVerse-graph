...
The per-episode `ep_coverages` arrays for §3a and §3b are preserved (they are in this
document's source workflows, `usevalpaper4-1` and `usevaldurM-1`, both still queryable).
