...
def test_launcher_accepts_only_the_approved_sweep_and_pins_training_semantics():
    source = _source()
    assert "pusht/action_flow_bc_usocket_latent_fm_sg_recon1_lr1e5_s42" in source
    assert "AF_EXPECTED_OPTIMIZER_LR=1e-5" in source
    assert "AF_EXPECTED_ETA_MIN=1e-6" in source
