...
from egomimic.models.oat.tokenizer.oat.model.attention import SelfAttention
from egomimic.models.oat.tokenizer.oat.model.drop_path import DropPath
from egomimic.models.oat.tokenizer.oat.model.mlp import GatedMlp, Mlp
    ...
    def forward(
        ...
        **kwargs,
        ...
        gate_msa, gate_mlp, shift_msa, scale_msa, shift_mlp, scale_mlp = (
            adaLN_emb_packed.chunk(6, dim=-1)
        )
