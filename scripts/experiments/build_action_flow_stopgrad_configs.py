...
def main() -> None:
    ...
    for label, mode, reconstruction_weight in VARIANTS:
        ...
        config = {
            ...
            "wandb": {
                "entity": "rl2-group",
                "project": "synthetic-action-flow-stopgrad",
                "id": run_id,
                "name": run_id,
                "resume": "never",
        ...
        "variants": [
            {
                "label": label,
                "clean_gradient_mode": mode,
                "lambda_reconstruction": weight,
            }
            for label, mode, weight in VARIANTS
        ],
        "control": "gaussian-torus-g-nonlinear-action-velocity-rec100-seed42-full-v2",
        "datasets": {
            "training": {
