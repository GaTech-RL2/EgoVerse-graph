...
Usage (CPU node, repo root, emimic venv):
    python scripts/pi05/precompute_norm_stats.py \
        --data pi05/mecka_all_pi_6d --model pi05/pi0.5_bc_mecka_6d \
