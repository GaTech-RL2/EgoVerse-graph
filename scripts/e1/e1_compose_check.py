...
for exp, variant in (
    ("fold_time", "time"),
    ("fold_arcmean", "arcmean"),
    ("fold_arcvel", "arcvel"),
    ("abc_arcdur", "arcdur"),
    ("abc_time", "time"),
    ("abc_arclogdur", "arclogdur"),
):
    ...
    try:
        with initialize_config_dir(
            ...
            cfg = compose(
                ...
                overrides=[
                    ...
                    "mode=eval",
                    "e1.spread=full",
                    f"e1.train_root={d}/test_mid",
                    f"e1.valid_root={d}/test_mid",
                    "e1.h_match_frames=33",
                    "e1.limit_val_batches=1.0",
                    "seed=42",
        ...
        print(
            f"  {exp:18} variant={variant:10} D={cfg.e1.D:<5} gt_span_m={gs}  "
